...
import { useCreatePairedLinkRoom } from '../features/chat/hooks/useCreatePairedLinkRoom'
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          ...
          <div className="flex flex-col gap-2 p-3 bg-blue-50 border border-blue-100 rounded-lg">
            ...
            >
              {createPairedLinkRoomMutation.isPending ? 'Создание...' : 'Создать комнату по ссылке'}
            </button>
          </div>
        </div>
      </div>
